                                ...
                                <table id="datatable-buttons" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:30%">Title of Expert Services Rendered</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:20%">Gabasa, Asuncion V. </td>
                                            <td style="width:10%">Expert</td>
                                            <td style="width:30%">The 2022 Curriculum Development Revision: Advancing the NPU Vision through a more Responsive, Nationally Relevant and Internationally Recognized Academic Program</td>
                                        ...
                                        <tr>
                                            <td style="width:10%">DEPARTMENT OF ENGLISH, FOREIGN LANGUAGES AND LINGUISTICS</td>
                                            <td style="width:20%">Gabasa, Asuncion V. </td>
                                            <td style="width:10%">Expert</td>
                                            <td style="width:30%">The 2022 Curriculum Development Revision: Advancing the NPU Vision through a more Responsive, Nationally Relevant and Internationally Recognized Academic Program</td>
                                            <td style="width:10%">April/23/2022 to April/23/2022 </td>
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="row  align-items-start ">
                                                                                ...
                                                                                <div class="input-group col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">First name</label>
                                                                                        <input type="text" class="form-control" id="first_name" name="first_name" style="width: 100%;" value=" Asuncion">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Middle name</label>
                                                                                        <input type="text" class="form-control" id="mid_name" name="mid_name" style="width: 100%;" value="V">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Last name</label>
                                                                                        <input type="text" class="form-control" id="last_name" name="last_name" style="width: 100%;" value="Gabasa">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group  col mb-3 ">
                                                                                    <div class="input-group">
                                                                            ...
                                                                            <div class="row  align-items-start col">
                                                                                ...
                                                                                <div class="input-group  col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Department</label>
                                                                                        <input type="text" class="form-control" id="last_name" name="last_name" style="width: 100%;" value="DEPARTMENT OF ENGLISH, FOREIGN LANGUAGES AND LINGUISTICS">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
