                                ...
                                <table id="datatable-buttons" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:30%">Understanding SOGIE: Knowing the Difference, Make All the Difference</td>
                                            <td style="width:10%">Planning</td>
                                            <td style="width:10%">June/28/2022 to 06/28/2022 </td>
                                            <td style="width:20%">
                                        ...
                                        <tr>
                                            <td style="width:10%">PUPQC</td>
                                            <td style="width:20%">Aribon, Mark Anthony III R</td>
                                            <td style="width:30%">Mid-Year Assessment and Planning</td>
                                            <td style="width:10%">Seminar</td>
                                            <td style="width:10%">June/23/2022 to June/24/2022 </td>
                                            <td style="width:20%">
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal2">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light">delete</button>
                                        ...
                                        <tr>
                                            <td style="width:10%">PUPQC</td>
                                            <td style="width:20%">Aquino Rodolfo Jr Y</td>
                                            <td style="width:30%">Project ReCITE Vol.II (Business and Finance, Humanities, Language and Communication) WEBINAR</td>
                                            <td style="width:10%">N/A</td>
                                            <td style="width:10%">March/29/2022 to April/01/2022 </td>
                                            <td style="width:20%">
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal2">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light">delete</button>
