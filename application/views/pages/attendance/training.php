        ...
        <div class="container-fluid">
            <div class="row">
                <div class="d-sm-flex flex-wrap mb-4">
                    <div class="col">
                        <h4 class="card-title mb-1">Attendance in Training</h4>
                    </div>
                                ...
                                <table id="datatable-buttons" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:20%">Oliquino, Joanna Marie DC. </td>
                                            <td style="width:30%">MS Teams for PUPQCEducators</td>
                                            <td style="width:10%">Workshop</td>
                                        ...
                                        <tr>
                                            <td style="width:10%">PUPQC</td>
                                            <td style="width:20%">Roxas, Rommel Y. </td>
                                            <td style="width:30%">PUP QC Webminar: Table of Specification & Test Item Analysis</td>
                                            <td style="width:10%">Seminar</td>
                                            <td style="width:10%">May/07/2022 to May/07/2022 </td>
                                            <td style="width:20%">
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal2">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light">delete</button>
                                        ...
                                        <tr>
                                            <td style="width:10%">PUPQC</td>
                                            <td style="width:20%">Fernandez, Alma C.</td>
                                            <td style="width:30%">MS TEAMS for PUPQC Educators</td>
                                            <td style="width:10%">Workshop/training</td>
                                            <td style="width:10%">April/23/2022 to April/23/2022</td>
                                            <td style="width:20%">
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal2">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width:30%">Understanding the Skills Required for Career Advancement</td>
                                            <td style="width:10%">N/A</td>
                                            <td style="width:10%">April/13/2022 to April/13/2022 </td>
                                            <td style="width:20%">
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal2">view</button>
                                                <button type=" button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                                <button type="button" class="btn btn-danger btn-rounded waves-effect waves-light">delete</button>
                                                                        ...
                                                                        <div class="col col-md-12" id="add_educ">
                                                                            <div class="row mb-4">
                                                                                ...
                                                                                <div class="col  mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Organizer</label>
                                                                                        <input type="text" class="form-control" id="first_name" name="first_name" style="width: 100%;" value="Polytechnic University of the Philippines">
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="col col-md-12 " id="add_educ">
                                                                            <div class="row mb-4">
                                                                                ...
                                                                                <div class="col  mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Level</label>
                                                                                        <input type="text" class="form-control" id="first_name" name="first_name" style="width: 100%;" value="Local - PUP">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col  mb-3 ">
                                                                                    <div class="input-group">
                                                                                ...
                                                                                <div class="col mb-3">
                                                                                    <label>Date started</label>
                                                                                    <div class="input-group" id="datepicker3">
                                                                                        <input type="text" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy" data-date-container='#datepicker3' data-provide="datepicker" data-date-autoclose="true" value="23/04/2022">
                                                                                ...
                                                                                <div class="col mb-3">
                                                                                    <label>Date ended</label>
                                                                                    <div class="input-group" id="datepicker4">
                                                                                        <input type="text" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy" data-date-container='#datepicker4' data-provide="datepicker" data-date-autoclose="true" value="23/04/2022">
                                                                                ...
                                                                                <div class="col  mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Total no. of hours</label>
                                                                                        <input type="text" class="form-control" id="first_name" name="first_name" style="width: 100%;" value="8">
                                                                                    </div>
                                                                                </div>
