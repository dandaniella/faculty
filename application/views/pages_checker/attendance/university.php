                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col col-md-12" id="cards">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <label class="custom-file-label" for="inputGroupFile03">Upload Proof of Attendance</label>
                                                                        <div class="col-md-12">
                                                                            <div class="col-md-12">
                                                                                <div class="mb-4 col-md-12">

                                                                                    <img src=" https://avatars.dicebear.com/api/bottts/smile.svg" alt="" class="img-fluid mx-auto d-block " style="object-fit:cover;" id="photo_path_placeholder" name="photo_path_placeholder">
                                                                                </div>
                                                                            </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="row  align-items-start col">
                                                                            <div class="input-group  col mb-5 ">
                                                                                <div class="input-group">
                                                                                    <label for="">Brief Description of Activity</label>
                                                                                    <input type="text" class="form-control" id="last_name" name="last_name" style="width: 100%;">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="col mb-3">
                                                                            ...
                                                                            <div class="input-group" id="datepicker6">
                                                                                <input type="text" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy" data-date-container='#datepicker6' data-provide="datepicker" data-date-autoclose="true">
                                                                                <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                            </div><!-- input-group -->
                                                                        </div>
                                                                        <div class="col mb-3">
                                                                            <label> Status of Attendanc</label>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-2">University Function Attended</h4>
                                <table id="datatable-buttons" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:10%">Status of Attendance</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="width:20%">Bulawit, Berna A.</td>
                                            <td style="width:30%">University Flag Raising Ceremony</td>
                                            <td style="width:10%">June/23/2022 to June/23/2022</td>
                                            <td style="width:10%">Attended</td>
                                            <td style="width:20%">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="row  align-items-start ">
                                                                                ...
                                                                                <div class="input-group col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">First name</label>
                                                                                        <input type="text" class="form-control" id="first_name" name="first_name" style="width: 100%;" value="Berna ">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Middle name</label>
                                                                                        <input type="text" class="form-control" id="mid_name" name="mid_name" style="width: 100%;" value="A.">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group col mb-3 ">
                                                                                    <div class="input-group">
                                                                                        <label for="">Last name</label>
                                                                                        <input type="text" class="form-control" id="last_name" name="last_name" style="width: 100%;" value="Bulawit">
                                                                                    </div>
                                                                                </div>
                                                                                <div class="input-group  col mb-3 ">
                                                                                    <div class="input-group">
                                                            ...
                                                            <div class="card">
                                                                <div class=" card-header bg-transparent border-bottom text-uppercase">
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="d-sm-flex flex-wrap">
                                                                            <div>
                                                                                <span>Attendance in University Function</span>
                                                                            </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="col-md-12">
                                                                                        <div class="mb-4 col-md-12">
                                                                                            <img src="<?php echo base_url('assets') ?>/images/pup/zoom.png" alt="" class="img-fluid mx-auto d-block " style="object-fit:cover;" id="photo_path_placeholder" name="photo_path_placeholder">
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="row  align-items-start col">
                                                                                    <div class="input-group  col mb-5 ">
                                                                                        <div class="input-group">
                                                                                            <label for="">Brief Description of Activity</label>
                                                                                            <input type="text" class="form-control" id="last_name" name="last_name" style="width: 100%;" value="University Flag Raising Ceremony">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col mb-3">
                                                                                    ...
                                                                                    <div class="input-group  mb-3">
                                                                                        ...
                                                                                        <select class="form-control" id="option-startView" name="startView">
                                                                                            <option>Choose...</i></option>
                                                                                            <option selected value="1">Attended</option>
                                                                                ...
                                                                                <div class="col mb-3">
                                                                                    <label>Date Stated</label>
                                                                                    <div class="input-group" id="datepicker5">
                                                                                        <input type="text" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy" data-date-container='#datepicker5' data-provide="datepicker" data-date-autoclose="true" value="23 Jun, 2022">
                                                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                                    </div><!-- input-group -->
                                                                                </div>
                                                                                <div class="col mb-3">
                                                                                    <label>Date Completed</label>
                                                                                    <div class="input-group" id="datepicker6">
                                                                                        <input type="text" class="form-control" placeholder="dd M, yyyy" data-date-format="dd M, yyyy" data-date-container='#datepicker6' data-provide="datepicker" data-date-autoclose="true" value="23 Jun, 2022">
                                                                                        <span class="input-group-text"><i class="mdi mdi-calendar"></i></span>
                                                                                    </div><!-- input-group -->
                                                                                </div>
