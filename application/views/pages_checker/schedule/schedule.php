                                                        ...
                                                        <div class=" card-header bg-transparent border-bottom text-uppercase">
                                                            ...
                                                            <div class="row">
                                                                <div class="d-sm-flex flex-wrap">
                                                                    ...
                                                                    <div class="ms-auto">
                                                                        <!-- Add user modal Button -->
                                                                        <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">Add degree</button>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>Aribon, Mark Anthony</td>
                                            <td>aribon.faculty@pup.edu</td>
                                            <td>Active</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Aquino Jr., Rodolfo Y.</td>
                                            <td>aquino.faculty@pup.edu</td>
                                            <td>Active</td>
                                            <td>
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                        ...
                                        <tr>
                                            <td>Bactasa, Melanie F.</td>
                                            <td>bactasa.faculty@pup.edu</td>
                                            <td>Active</td>
                                            <td>
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
                                        ...
                                        <tr>
                                            <td>Bulawit, Berna A.</td>
                                            <td>bulawit.faculty@pup.edu</td>
                                            <td>Active</td>
                                            <td>
                                                <button type="button" class="btn btn-secondary btn-rounded waves-effect waves-light">view</button>
                                                <button type="button" class="btn btn-primary btn-rounded waves-effect waves-light">edit</button>
