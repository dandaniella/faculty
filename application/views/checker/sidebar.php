      ...
      <div data-simplebar class="h-100">
        ...
        <div id="sidebar-menu">
          ...
          <ul class="metismenu list-unstyled" id="side-menu">
            ...
            <li>
              <a href="<?php echo base_url('Checker/dashboard') ?>" class="waves-effect">
                <i class="bx bx-home-circle"></i>
                <span key="t-dashboards">Dashboards</span>
              </a>
            </li>
            <li>
              <a href="<?php echo base_url('Checker/profile') ?>" class="waves-effect">
                <i class="bx bx-home-circle"></i>
                <span key="t-dashboards">Faculty Profile</span>
              </a>
            </li>
            <li>
              <a href="<?php echo base_url('Checker/schedule') ?>" class="waves-effect">
                <i class="bx bx-home-circle"></i>
            ...
            <li>
              ...
              <ul class="sub-menu" aria-expanded="true">
                <li>
                  <a href="<?php echo base_url('Checker/research') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
                    <span key="t-dashboards">Research</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Checker/extension') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
                    <span key="t-dashboards">Extension</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Checker/awards') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
                    <span key="t-dashboards">Awards</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Checker/study') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
            ...
            <li>
              ...
              <ul class="sub-menu" aria-expanded="true">
                <li>
                  <a href="<?php echo base_url('Checker/rfdp') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
                    <span key="t-dashboards">RFDP</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Checker/training') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
                    <span key="t-dashboards">Trainings</span>
                  </a>
                </li>
                <li>
                  <a href="<?php echo base_url('Checker/university') ?>" class="waves-effect">
                    <i class="bx bx-home-circle"></i>
