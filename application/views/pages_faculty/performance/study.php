                                ...
                                <table id="datatable-buttons" class="table table-bordered">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width:40%">Degree/Program</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="width:40%">PhD in Educational Leadership and Management Program Major in Educational Management</td>
                                            <td style="width:20%">Pacific Intercontinental Collge</td>
                                            <td style="width:20%">On going</td>
                                            <td style="width:20%">
